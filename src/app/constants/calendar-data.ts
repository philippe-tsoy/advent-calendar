...
export const CALENDAR_DAYS: CalendarDay[] = [
  ...
  { day: 15, display: '15', message: 'Like the sun in July, she warms me to my bones \n She caresses my cold weathered skin \n She irradiates me with her kindness, her love \n And leaves me with a kiss on the cheek', imagePath: 'assets/images/day-15.jpg' },
  { day: 16, display: '16', message: 'On the opposite side of a church let us celebrate\nOur first christmas. Let\'s find the best gifts\nAre they required for our standards to elevate\nOr just a kiss is enough in the lift', imagePath: 'assets/images/day-16.jpg' },
  { day: 17, display: '17', message: 'A rose in the mouth call me Zoro, the masked masked thief\nI came and I stole your heart, took every piece\nBut caught in the heat, I did not realize that\nYou clutched mine so hard and you\'ll never release', imagePath: 'assets/images/day-17.jpg' },
  { day: 18, display: '18', message: 'Bestest gift giver, so thoughtful, so artsy\nThank you for loving me even in dreams\nThings that I love about you, plenty like shark teeth\nAnd kisses way softer than hands when you sleep', imagePath: 'assets/images/day-18.jpg' },
  { day: 19, display: '19', message: 'Fresh rain made shiny the floors of the convent\nAnd holiday lights were reflected within\nBut none of them could rivalize those on your end\nFor your smiling eyes made my future written', imagePath: 'assets/images/day-19.jpg' },
