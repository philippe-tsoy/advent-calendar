...
Was blasting the chorus
And love did all our fears defeat`,imagePath:"assets/images/day-31.jpg"},{day:32,display:"Happy New Year!",message:"Happy New Year my love!",imagePath:"assets/images/day-32.jpg"}];var m=class o{STORAGE_KEY="advent-calendar-custom-data";getDayData(e){let a=this.getCustomData().find(n=>n.day===e);if(a)return a;let t=r.find(n=>n.day===e);return t?{day:t.day,display:t.display,message:t.message,imagePath:t.imagePath}:{day:e,message:`Day ${e}`,imagePath:""}}getAllDays(){let e=this.getCustomData(),s=[];for(let a=1;a<=32;a++){let t=e.find(n=>n.day===a);if(t)s.push(t);else{let n=r.find(y=>y.day===a);n?s.push({day:n.day,display:n.display,message:n.message,imagePath:n.imagePath}):s.push({day:a,message:`Day ${a}`,imagePath:""})}}return s}saveDayData(e){let s=this.getCustomData(),a=s.findIndex(t=>t.day===e.day);a>=0?s[a]=i({},e):s.push(i({},e)),localStorage.setItem(this.STORAGE_KEY,JSON.stringify(s))}deleteDayData(e){let a=this.getCustomData().filter(t=>t.day!==e);localStorage.setItem(this.STORAGE_KEY,JSON.stringify(a))}getCustomData(){let e=localStorage.getItem(this.STORAGE_KEY);if(e)try{return JSON.parse(e).map(a=>l(i({},a),{day:typeof a.day=="number"?a.day:Number(a.day)}))}catch{return[]}return[]}getImageUrl(e){return e.imageData?e.imageData:e.imagePath}static \u0275fac=function(s){return new(s||o)};static \u0275prov=d({token:o,factory:o.\u0275fac,providedIn:"root"})};export{m as a};
