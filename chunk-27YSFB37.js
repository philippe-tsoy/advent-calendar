import{L as l,a as n,b as d}from"./chunk-VX6IEPVJ.js";var r=[{day:1,display:"1",message:"Happy December bunbun! Here is a lil gift for you, your own advent calendar! I hope you enjoy it!",imagePath:"assets/images/day-1.jpg"},{day:2,display:"2",message:`Your arms like a garland, your eyes like a star 
...
But you'll still be stuck in my heart, my brain, and all my dreams`,imagePath:"assets/images/day-26.jpg"},{day:27,display:"27",message:"Day 27: Holiday continues! \u{1F381}",imagePath:"assets/images/day-27.jpg"},{day:28,display:"28",message:"5 days to New Year! \u{1F389}",imagePath:"assets/images/day-28.jpg"},{day:29,display:"3 days to New Year!",message:"4 days to New Year! \u{1F389}",imagePath:"assets/images/day-29.jpg"},{day:30,display:"2 days to New Year!",message:"3 days to New Year! \u{1F389}",imagePath:"assets/images/day-30.jpg"},{day:31,display:"1 day to New Year!",message:"2 days to New Year! \u{1F389}",imagePath:"assets/images/day-31.jpg"},{day:32,display:"Happy New Year!",message:"Happy New Year! \u{1F389}",imagePath:"assets/images/day-32.jpg"}];var m=class o{STORAGE_KEY="advent-calendar-custom-data";getDayData(e){let a=this.getCustomData().find(i=>i.day===e);if(a)return a;let t=r.find(i=>i.day===e);return t?{day:t.day,display:t.display,message:t.message,imagePath:t.imagePath}:{day:e,message:`Day ${e}`,imagePath:""}}getAllDays(){let e=this.getCustomData(),s=[];for(let a=1;a<=32;a++){let t=e.find(i=>i.day===a);if(t)s.push(t);else{let i=r.find(y=>y.day===a);i?s.push({day:i.day,display:i.display,message:i.message,imagePath:i.imagePath}):s.push({day:a,message:`Day ${a}`,imagePath:""})}}return s}saveDayData(e){let s=this.getCustomData(),a=s.findIndex(t=>t.day===e.day);a>=0?s[a]=n({},e):s.push(n({},e)),localStorage.setItem(this.STORAGE_KEY,JSON.stringify(s))}deleteDayData(e){let a=this.getCustomData().filter(t=>t.day!==e);localStorage.setItem(this.STORAGE_KEY,JSON.stringify(a))}getCustomData(){let e=localStorage.getItem(this.STORAGE_KEY);if(e)try{return JSON.parse(e).map(a=>d(n({},a),{day:typeof a.day=="number"?a.day:Number(a.day)}))}catch{return[]}return[]}getImageUrl(e){return e.imageData?e.imageData:e.imagePath}static \u0275fac=function(s){return new(s||o)};static \u0275prov=l({token:o,factory:o.\u0275fac,providedIn:"root"})};export{m as a};
